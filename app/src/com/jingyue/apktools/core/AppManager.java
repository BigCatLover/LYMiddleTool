...
public class AppManager {
    ...
    public static String SHELL_ZIP = "jiagu.zip";
    ...
    public static File getShellZip() {
        File dir;
        if (AppManager.isReleased) {
            dir = new File(getAppPath(), "build-res" + File.separator + SHELL_ZIP);
        } else {
            dir = new File(getRuntimeDir(), "lib.Res" + File.separator +"tools" + File.separator + SHELL_ZIP);
        }
        return dir;
    }
